function [samples_x,samples_y] = getSamples_RW_fieldData_sub_3( samples_N,...
    modes_num_vec,index_vec_all,f_vector,Vp_known,den_known,Vs_profile_lower,Vs_profile_upper,dispersions_R_true,h_known)
